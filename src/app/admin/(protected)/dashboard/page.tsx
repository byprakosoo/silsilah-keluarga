...
export default async function DashboardPage() {
  ...
  return (
    <div>
      ...
      <p className="body-md text-[var(--on-surface-variant)] mb-8" style={{ fontFamily: "var(--font-elms-sans), sans-serif" }}>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <Card className="border-[var(--outline-variant)] bg-[var(--surface-container-lowest)] shadow-heritage">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-[var(--on-surface-variant)]" style={{ fontFamily: "var(--font-elms-sans), sans-serif" }}>Total Anggota</CardTitle>
        ...
        <Card className="border-[var(--outline-variant)] bg-[var(--surface-container-lowest)] shadow-heritage">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-[var(--on-surface-variant)]" style={{ fontFamily: "var(--font-elms-sans), sans-serif" }}>Anggota Hidup</CardTitle>
        ...
        <Card className="border-[var(--outline-variant)] bg-[var(--surface-container-lowest)] shadow-heritage">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium text-[var(--on-surface-variant)]" style={{ fontFamily: "var(--font-elms-sans), sans-serif" }}>Generasi</CardTitle>
